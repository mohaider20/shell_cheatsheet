...
| `eval "$(string)"`        | Evaluate & execute command string | Takes a string and executes is as a command                         |
...
_This cheatsheet provides a quick reference to commonly used shell commands and their options. For more detailed information, refer to the manual pages using the `man` command._
